    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{Route::currentRouteName()=='pending-users'?'active':''}}">
                    <a href="{{route('pending-users')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-user"></i>
                        <div data-i18n="Tables">Pending Users</div>
                    </a>
                </li>
                <li class="menu-item {{Route::currentRouteName()=='registered-users'?'active':''}}{{Route::currentRouteName()=='view-user'?'active':''}}">
                    <a href="{{route('registered-users')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-user-check"></i>
                        <div data-i18n="Tables">Registered Users</div>
                    </a>
                </li>
                <li class="menu-item {{Route::currentRouteName()=='denied-users'?'active':''}}">
                ...
                <li class="menu-item {{Route::currentRouteName()=='show-payments-report'?'active':''}}">
                ...
                <li class="menu-item {{Route::currentRouteName()=='show-loans-report'?'active':''}}">
